...
const Secure = forwardRef(function Secure(props, ref) {
  ...
  return (
    <div ref={ref} className="w-[100%] lg:flex h-screen">
      <div className="lg:w-[50%] lg:px-[2.5rem] px-[1rem] flex items-center">
        <div className="w-full mt-10 lg:mt-0">
          ...
          <p className="text-gray-400 leading-8 text-left mt-4">
            ...
            you have worked for all your years is not in vain. If you do not
            decide
            <br className="hidden md:block" />
            now, your assets may end up in the wrong hands.
          </p>
      ...
      <div className="lg:w-[50%] px-[1rem] flex items-center mt-5 lg:mt-0">
