...
const Secure = forwardRef(function Secure(props, ref) {
  const steps = [
    ...
    {
      number: 2,
      title: "Fill out the asset claim form",
      description:
        "Begin to document, catalog and assign all your valuable assets in one place.",
    },
    {
      number: 3,
      title: "Get verified and view deceased’s assets",
      description:
        "We ensures that your assets are protected and accessible to your loved ones in the event of your passing.",
    },
    {
      number: 4,
      title: "Secure Exit",
